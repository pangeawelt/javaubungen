...
public class _130_Korrektes_Datum_Gani {
    ...
    public static void main(String[] args) {
        ...
        int monat=12;
        int tag=26;
        String korrekheit="datok(0)";
        String nochnicht= "datok (1)";
       ...
       String datum = scanner.nextLine();
        ...
        String jahrs = datum.substring(7);
        ...
        if (jahr > 1900 && jahr < 2100 ) {
            if (monat <= 12) {
                if ((monat != 2 && tag <= 31) || (monat == 2 && tag <= 28) ||
                        (monat == 2 && (jahr%4 == 0 && (jahr%100 != 0 || jahr%400 == 0) && tag <= 29))) {
